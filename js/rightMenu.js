...
const defaultEncoding = translate?.defaultEncoding || 2; /* 網站默認語言，1: 繁體中文, 2: 簡體中文 */
const translateDelay = translate?.translateDelay || 0; /* 延遲時間,若不在前, 要設定延遲翻譯時間, 如100表示100ms,默認為0 */
